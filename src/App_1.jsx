...
Responde SOLO con el JSON, sin texto adicional, sin backticks.`;
    ...
    try {
      ...
      if (!response.ok || data.error) throw new Error(data.error?.message || "Error de API");
      ...
      setError("Los astros no hablan con claridad ahora. Intenta de nuevo en un momento. 🌑");
    } finally {
      setLoading(false);
    }
  }
